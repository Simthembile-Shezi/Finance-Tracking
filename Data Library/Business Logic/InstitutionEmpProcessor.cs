...
namespace Data_Library.Business_Logic
{
    public static class InstitutionEmpProcessor
    {
        ...
        public static int AddInstitutionEmp(string Emp_FName, string Emp_LName, string Emp_Telephone_Number, string Emp_Email, string Organization_Name, string Password)
        {
            InstitutionEmployeeDB data = new InstitutionEmployeeDB
            {
                Emp_FName = Emp_FName,
            ...
            string sql = @" insert into [dbo].[Institution Employee] (Emp_FName, Emp_LName, Emp_Telephone_Number, Emp_Email, Organization_Name, Password)
